...
?>
		...
		<div class="large-12 medium-12 columns">
			<div class="carousel" style="margin-bottom: 0px;">
				<div class='about-section'>
					<a href="artist/supertest/img1">
						<?= Asset::img('arts/91Eu7Lv.png'); ?>
					</a>
				</div>
				<div class='about-section'>
					<a href="artist/supertest/img2">
						<?= Asset::img('arts/jps0Zc1.jpg'); ?>
					</a>
				</div>
				<div class='about-section'>
					<a href="artist/supertest/img3">
						<?= Asset::img('arts/gvQWR0B.png'); ?>
					</a>
				</div>
			</div>
		</div>
	...
	<div class="row show-for-small-only">
		<div class="small-12 columns">
			<section>
				<a href="artist/supertest/img1">
					<?= Asset::img('arts/m_91Eu7Lv.png'); ?>
				</a>
				<h6 class="panel inverse">
					Description
				</h6>
			</section>
			<section>
				<a href="artist/supertest/img1">
					<?= Asset::img('arts/m_jps0Zc1.jpg'); ?>
				</a>
				<h6 class="panel inverse">
					Description
				</h6>
